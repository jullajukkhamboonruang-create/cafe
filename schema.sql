...
-- 9. เพิ่มรายการข้อมูลสินค้าตัวอย่างเริ่มต้น สำหรับใช้เปิดระบบขายกาแฟและขนมเบเกอรี่
INSERT INTO products (name, price, category, points_value, image_url) VALUES
('Espresso (ร้อน)', 50.00, 'coffee', 1, 'https://images.unsplash.com/photo-1510707577719-0d7fe5b3940a?w=400&q=80'),
('Iced Americano', 60.00, 'coffee', 1, 'https://images.unsplash.com/photo-1517701604599-bb29b565090c?w=400&q=80'),
('Iced Latte', 65.00, 'coffee', 1, 'https://images.unsplash.com/photo-1541167760496-1628856ab772?w=400&q=80'),
('Iced Cappuccino', 65.00, 'coffee', 1, 'https://images.unsplash.com/photo-1572442388796-11668a67e53d?w=400&q=80'),
('Matcha Latte เย็น', 70.00, 'coffee', 1, 'https://images.unsplash.com/photo-1536256263959-770b48d82b0a?w=400&q=80'),
('Butter Croissant', 85.00, 'bakery', 2, 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=400&q=80'),
('Chocolate Cake', 95.00, 'bakery', 2, 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=400&q=80'),
('Blueberry Cheesecake', 120.00, 'bakery', 2, 'https://images.unsplash.com/photo-1533134242443-d4fd215305ad?w=400&q=80'),
('Strawberry Waffle', 110.00, 'bakery', 2, 'https://images.unsplash.com/photo-1562376502-6f769499c886?w=400&q=80'),
('Chocolate Chip Cookie', 45.00, 'bakery', 1, 'https://images.unsplash.com/photo-1499636136210-6f4ee915583e?w=400&q=80');

-- 10. เพิ่มข้อมูลลูกค้าสมาชิกสะสมแต้มเริ่มต้นสำหรับทดสอบระบบ
INSERT INTO members (name, phone, points) VALUES
('สมชาย ใจดี', '0812345678', 15),
('สมหญิง รักดี', '0898765432', 80),
